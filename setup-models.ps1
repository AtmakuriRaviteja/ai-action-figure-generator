...
# 2a. Counterfeit V3.0 (Anime)
Download-Resilient "https://huggingface.co/gsdf/Counterfeit-V3.0/resolve/main/Counterfeit-V3.0_fp16.safetensors" (Join-Path $WebUIDir "models\Stable-diffusion\counterfeit_v30.safetensors")

# 2b. Anything V5 (Anime Portrait)
Download-Resilient "https://huggingface.co/stablediffusionapi/anything-v5/resolve/main/anything-v5.safetensors" (Join-Path $WebUIDir "models\Stable-diffusion\anything-v5.safetensors")

# 2c. ReV Animated (Semi Realistic)
Download-Resilient "https://huggingface.co/s6yx/ReV_Animated/resolve/main/revAnimated_v122.safetensors" (Join-Path $WebUIDir "models\Stable-diffusion\revAnimated_v122.safetensors")
